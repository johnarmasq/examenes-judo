...
* Saludo inicial clase de Judo (Protocolo en ceremonia de saludo).
...
Otagai ni rei (Saludo a los compañeros)
Kiritsu (De pie)
Kiotsuke (Firme)
Tachi rei (Saludo de pie)

* Conocimientos generales de su Club de Judo (Nombre, Logo, Presidente, Entrenadores, Compañeros).

* Teoría sobre la organización de su Liga de Judo (Organigrama, Presidente, Ubicación de oficina de atención, Redes sociales, Página web).
## TAISO

* Rollo o vuelta adelante largo
* Rollo o vuelta atrás con piernas abiertas.
* Rondada

## UKEMIS

* Ushiro-ukemi con obstáculos. (Caida atras)
* Yoko-ukemi con obstáculos. (caida de lado)
* Mae-mawari-ukemi con obstáculos (Zenpo-kaiten-ukemi). (Rollo con caida)
* Mae-mawari-ukemi con rodillo en línea.

## REGLAMENTO

* Hajime (Comenzar)
* Mate (Parar)
* Osae-komi (Inmobilizacion/Pin)
* Toketa (Paro de inmobilizacion)
* Sore-made (Fin del tiempo de combate)
* Waza-ari-awassete-ippon (2 waza ari que hacen un ippon)
* Shido (Penalidad)
